...
class AsyncInvitationsClient:
    ...
    async def create(
        ...
        *,
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.tenants.invitations.create(email='email', )
        asyncio.run(main())
        """
    ...
    async def resend(
        ...
        *,
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.tenants.invitations.resend(invitation_id='invitationId', )
        asyncio.run(main())
        """
    ...
    async def get(
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.tenants.invitations.get(invitation_id='invitationId', )
        asyncio.run(main())
        """
    ...
    async def delete(self, invitation_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.tenants.invitations.delete(invitation_id='invitationId', )
        asyncio.run(main())
        """
