...
class BasisTheory:
    ...
    def agentic(self):
        if self._agentic is None:
            from .agentic.client import AgenticClient  # noqa: E402

            self._agentic = AgenticClient(client_wrapper=self._client_wrapper)
...
class AsyncBasisTheory:
    ...
    def agentic(self):
        if self._agentic is None:
            from .agentic.client import AsyncAgenticClient  # noqa: E402

            self._agentic = AsyncAgenticClient(client_wrapper=self._client_wrapper)
        return self._agentic
