...
from ..types.reactor_runtime import ReactorRuntime
...
class RawReactorsClient:
    ...
    ) -> SyncPager[Reactor, ReactorPaginatedList]:
        """
        Parameters
        ----------
    ...
    def create(
        ...
        *,
        ...
        runtime: typing.Optional[ReactorRuntime] = OMIT,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "runtime": convert_and_respect_annotation_metadata(
                    object_=runtime, annotation=ReactorRuntime, direction="write"
                ),
            },
            headers={
    ...
    def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[Reactor]:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"reactors/{encode_path_param(id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def react(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"reactors/{encode_path_param(id)}/react",
            method="POST",
            json=request,
            request_options=request_options,
            omit=OMIT,
    ...
    def react_async(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"reactors/{encode_path_param(id)}/react-async",
            method="POST",
            json=request,
            request_options=request_options,
            omit=OMIT,
...
class AsyncRawReactorsClient:
    ...
    async def list(
        ...
        *,
        ...
        size: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncPager[Reactor, ReactorPaginatedList]:
        """
        Parameters
        ----------
        id : typing.Optional[typing.Union[str, typing.Sequence[str]]]
