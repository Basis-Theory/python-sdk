...
class RawSessionsClient:
    ...
    def authenticate(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"3ds/sessions/{encode_path_param(session_id)}/authenticate",
            method="POST",
            json={
    ...
    def get_challenge_result(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"3ds/sessions/{encode_path_param(session_id)}/challenge-result",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[ThreeDsSession]:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"3ds/sessions/{encode_path_param(id)}",
            method="GET",
            request_options=request_options,
        )
        try:
