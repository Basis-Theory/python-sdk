...
class AsyncSessionsClient:
    ...
    async def authenticate(
        ...
        *,
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.threeds.sessions.authenticate(session_id='sessionId', authentication_category='authentication_category', authentication_type='authentication_type', )
        asyncio.run(main())
        """
    ...
    async def get_challenge_result(
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.threeds.sessions.get_challenge_result(session_id='sessionId', )
        asyncio.run(main())
        """
    ...
    async def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> ThreeDsSession:
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.threeds.sessions.get(id='id', )
        asyncio.run(main())
        """
