...
class AsyncDomainClient:
    ...
    async def deregister(self, *, domain: str, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        async def main() -> None:
            await client.connections.apple_pay.domain.deregister(
                domain="domain",
            )
    ...
    async def get(
        ...
        async def main() -> None:
            await client.connections.apple_pay.domain.get()
    ...
    async def register(
        ...
        async def main() -> None:
            await client.connections.apple_pay.domain.register(
                domain="domain",
            )
    ...
    async def register_all(
        ...
        *,
        ...
        async def main() -> None:
            await client.connections.apple_pay.domain.register_all()
