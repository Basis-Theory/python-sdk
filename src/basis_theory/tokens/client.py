    ...
    def search_v2(
        ...
        *,
        ...
        for page in response.iter_pages():
            yield page
        """
        _response = self._raw_client.search_v2(
...
class AsyncTokensClient:
    ...
    async def detokenize(
        ...
        async def main() -> None:
            await client.tokens.detokenize(request={'key': 'value'}
            , )
        asyncio.run(main())
        """
    ...
    async def tokenize(
        ...
        *,
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.tokens.tokenize(request={'key': 'value'}
            , )
        asyncio.run(main())
        """
    ...
    async def delete(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.tokens.delete(id='id', )
        asyncio.run(main())
        """
    ...
    async def update(
        ...
        *,
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.tokens.update(id='id', )
        asyncio.run(main())
        """
    ...
    async def search_v2(
        ...
        *,
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.search_v2(
            query=query, start=start, size=size, idempotency_key=idempotency_key, request_options=request_options
        )
        return _response.data
