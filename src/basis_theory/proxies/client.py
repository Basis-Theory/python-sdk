...
class AsyncProxiesClient:
    ...
    async def create(
        ...
        *,
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.proxies.create(name='name', destination_url='destination_url', )
        asyncio.run(main())
        """
    ...
    async def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> Proxy:
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.proxies.get(id='id', )
        asyncio.run(main())
        """
    ...
    async def update(
        ...
        *,
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.proxies.update(id='id', name='name', destination_url='destination_url', )
        asyncio.run(main())
        """
    ...
    async def delete(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.proxies.delete(id='id', )
        asyncio.run(main())
        """
    ...
    async def patch(
        ...
        *,
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.proxies.patch(id='id', )
        asyncio.run(main())
        """
