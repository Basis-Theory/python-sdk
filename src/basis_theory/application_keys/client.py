...
class AsyncApplicationKeysClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            await client.application_keys.list(id_='id', )
        asyncio.run(main())
        """
    ...
    async def create(
        ...
        *,
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.application_keys.create(id='id', )
        asyncio.run(main())
        """
    ...
    async def get(
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.application_keys.get(id='id', key_id='keyId', )
        asyncio.run(main())
        """
    ...
    async def delete(self, id: str, key_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.application_keys.delete(id='id', key_id='keyId', )
        asyncio.run(main())
        """
