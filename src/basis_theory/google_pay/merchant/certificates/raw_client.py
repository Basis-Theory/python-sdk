...
class RawCertificatesClient:
    ...
    def get(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"google-pay/merchant-registration/{encode_path_param(merchant_id)}/certificates/{encode_path_param(id)}",
            method="GET",
    ...
    def create(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"google-pay/merchant-registration/{encode_path_param(merchant_id)}/certificates",
            method="POST",
            json={
