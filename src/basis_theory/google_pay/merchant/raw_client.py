...
class RawMerchantClient:
    ...
    def get(
    ...
    ) -> HttpResponse[GooglePayMerchant]:
        """
        Parameters
        ----------
        id : str
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"google-pay/merchant-registration/{encode_path_param(id)}",
            method="GET",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    GooglePayMerchant,
                    parse_obj_as(
                        type_=GooglePayMerchant,  # type: ignore
...
class AsyncRawMerchantClient:
    ...
    async def get(
        self, id: str, *, request_options: typing.Optional[RequestOptions] = None
    ) -> AsyncHttpResponse[GooglePayMerchant]:
        """
        Parameters
        ----------
        id : str
