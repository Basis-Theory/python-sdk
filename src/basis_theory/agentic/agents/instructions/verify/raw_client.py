...
class RawVerifyClient:
    ...
    def start(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"agents/{jsonable_encoder(agent_id)}/instructions/{jsonable_encoder(instruction_id)}/verify",
            method="POST",
            json={
    ...
    def passkey(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"agents/{jsonable_encoder(agent_id)}/instructions/{jsonable_encoder(instruction_id)}/verify/passkey",
            method="POST",
            json={
