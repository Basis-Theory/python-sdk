...
class RawInstructionsClient:
    ...
    def list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"agents/{jsonable_encoder(agent_id)}/instructions",
            method="GET",
            params={
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"agents/{jsonable_encoder(agent_id)}/instructions/{jsonable_encoder(instruction_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
...
class AsyncRawInstructionsClient:
    ...
    async def list(
        ...
        *,
        ...
        cursor: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[InstructionList]:
        """
        List all purchase instructions for an agent with cursor-based pagination and optional enrollment filter.
