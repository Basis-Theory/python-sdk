...
class RawEnrollmentsClient:
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"enrollments/{jsonable_encoder(enrollment_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def retry(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"enrollments/{jsonable_encoder(enrollment_id)}/retry",
            method="POST",
            request_options=request_options,
        )
        try:
...
class AsyncRawEnrollmentsClient:
    ...
    async def list(
        ...
        *,
        ...
        cursor: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[EnrollmentList]:
        """
        List all enrollments for the current tenant with cursor-based pagination.
