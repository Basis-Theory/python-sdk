...
class AsyncWebhooksClient:
    ...
    async def get(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> Webhook:
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.webhooks.get(id='id', )
        asyncio.run(main())
        """
    ...
    async def update(
        ...
        *,
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.webhooks.update(id='id', name='webhook-update', url='http://www.example.com', events=['token:created'], )
        asyncio.run(main())
        """
    ...
    async def delete(self, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.webhooks.delete(id='id', )
        asyncio.run(main())
        """
    ...
    async def create(
        ...
        *,
        ...
        client = AsyncBasisTheory(correlation_id="YOUR_CORRELATION_ID", api_key="YOUR_API_KEY", )
        async def main() -> None:
            await client.webhooks.create(name='webhook-create', url='http://www.example.com', events=['token:created'], )
        asyncio.run(main())
        """
